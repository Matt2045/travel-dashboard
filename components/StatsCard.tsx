            ...
            <div className="content">
                <div className="flex flex gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-grey-100 truncate">vs last months</p>
                    </div>

                    <img
                        src={`/assets/icons/${isDecrement ? "decrement.svg" : "increment.svg"}`} className="xl:w-32 w-full h-full md:h-32 xl:h-full" alt="trend graph"
                    />
                </div>
            </div>
        </article>
